...
au_docs <- open_dataset("s3://com-copyright-agpipeline-sandds/data/output/phyeng/json/graph/nodes/r4r_projection_authors", format = "json") # json projection
...
### Distributions of Key Node Properties
```{r}
# occurences
...
# tibble(
#   edge = c("affiliated_to", "contributed_to", "topics_of_interest", "collaborated_with"),
#   count = c(count_aff[[1]], count_contr[[1]], count_topics[[1]], count_collab[[1]])
# )
```
